...
export class ModalSimpleExampleComponent {
    ...
    confirm(): void {
        ...
        const options: SimpleModalOptions = {
            message:
                'Good decisions come from experience. Experience comes from bad decisions. This is life... so, never regret. Learn from mistakes and go ahead. (Mark Twain)',
    ...
    confirmDelete(): void {
        ...
        this.modalService.confirmDestructive(options).subscribe(confirmed => {
            if (confirmed) {
