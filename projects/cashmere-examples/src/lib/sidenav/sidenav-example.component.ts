...
export class SidenavExampleComponent {
    ...
    tabs: SidenavLink[] = [
        new SidenavLink({
            ...
            badgeHTML: '<span title="I am number 4">4</span>',
            badgeColor: 'slate-gray-300'
        }),
        ...
        new SidenavLink({
            title: 'Space',
            labelHTML: '<em>Space</em>',
            iconClass: 'fa fa-rocket',
            description: 'Travel amongst the stars',
            subText: '$$$'
        })
    ];
    favs: SidenavLink[] = [
        new SidenavLink({
            title: 'Toyota Tacoma',
            iconClass: 'fa fa-car fav-travel-ico fav-ico-teal',
        ...
        new SidenavLink({
            title: 'Boeing 737',
            iconClass: 'fa fa-plane fav-travel-ico fav-ico-blue',
