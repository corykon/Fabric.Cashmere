        ...
        beforeEach(
            waitForAsync(() => {
                TestBed.configureTestingModule({
                    ...
                    providers: [
                        AppSwitcherService,
                        { provide: APP_SWITCHER_CONFIG, useValue: { discoveryServiceUri: 'foo://bar/baz/v1' } },
        ...
        beforeEach(
            waitForAsync(() => {
                TestBed.configureTestingModule({
                    ...
                    providers: [
                        AppSwitcherService,
                        { provide: APP_SWITCHER_CONFIG, useValue: { discoveryServiceUri: 'foo://bar/baz/' } },
                        provideHttpClient(withInterceptorsFromDi()),
                        provideHttpClientTesting()
                    ]
                });
        ...
        beforeEach(
            waitForAsync(() => {
                TestBed.configureTestingModule({
                    ...
                    providers: [
                        AppSwitcherService,
                        { provide: APP_SWITCHER_CONFIG, useValue: {} },
                        provideHttpClient(withInterceptorsFromDi()),
                        provideHttpClientTesting()
                    ]
                });
