...
@Component({
    template: `
        <hc-scroll-nav #ScrollNav>
            <ul>
                <li hcScrollLink="a1" (navClick)="testNavEvent($event)">Test 1</li>
            </ul>
        </hc-scroll-nav>
...
@Component({
    template: `
        <hc-scroll-nav #ScrollNav>
            <ul>
                <li [attr.hcScrollLink]="'a2'">Test 1</li>
            </ul>
        </hc-scroll-nav>
        <hc-scroll-nav-content [nav]="ScrollNav">
...
describe('ScrollNavLinkDirective', (): void => {
    ...
    describe('when used in a non-dynamic component', (): void => {
        ...
        beforeEach(() => {
            directive = scrollNavLinkComponent.debugElement
                .query(By.directive(ScrollNavLinkDirective))
